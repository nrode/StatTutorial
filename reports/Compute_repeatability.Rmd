...
## Create dataset
data <- expand.grid(id=as.factor(1:n_ind), replicate=paste0("rep", 1:k_rep))
...
## Expected variance
(Var_R_expected=(2*(1-R_expected)^2*(1+(k_rep-1)*R_expected)^2)/(k_rep*(k_rep-1)*(n_ind-1)))
